...
| `telemetry.enabled` | boolean | `true` | Allow anonymous diagnostics, including install/update version pings and crash reports when available. This does not control update checks |
