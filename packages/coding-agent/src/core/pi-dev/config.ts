...
export const PI_DEV_ACTIVITY_SYNC_ENABLED_STATUS = "activity sync enabled. It can be disabled in /settings";
export const PI_DEV_PROFILE_CONNECTED_STATUS = `pi.dev profile connected; ${PI_DEV_ACTIVITY_SYNC_ENABLED_STATUS}`;
